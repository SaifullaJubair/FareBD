...
const AllComments = () => {
   ...
   useEffect(() => {
      fetch(`https://server-fare-bd.vercel.app/allcomments/`)
         .then(res => res.json())
         .then(data => {
            // console.log(data);
            setAllComments(data)
   ...
   const handleDeleteComment = comment => {
      fetch(`https://server-fare-bd.vercel.app/comment/${comment?._id}`, {
         method: 'DELETE'
      })
         .then(res => res.json())
         .then(data => {
   ...
   return (
      <div className='flex'>
         ...
         <div className='mx-auto flex-grow overflow-x-auto'>
            {
               allComments ? <h2 className='title uppercase p-10 text-center mb-10 bg-secondary text-white text-2xl font-semibold'>All Comments </h2> :
                  <Loader></Loader>
            }
            {
               allComments?.length ? <p></p> :
               ...
               <div className="relative w-full h-full max-w-md md:h-auto">
                  <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                     ...
                     <div className="p-6 text-center">
                        ...
                        <button
                           onClick={() => handleDeleteComment(deleteData)}
                           data-modal-hide="popup-modal"
                           type="button"
                        ...
                        <div>
                           ...
                           <div>
                              ...
                              <div className="flex justify-center gap-4">
                                 <Button
                                    color="success"
                                    onClick={() => handleUpdateComment(editData)}
                                 >
                                    Update
                                 </Button>
                                 <Button
