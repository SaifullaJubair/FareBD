...
const MyProperties = () => {
   ...
   const getMyPosts = async () => {
      const res = await fetch(`https://server-fare-bd.vercel.app/my-posts/${user?.email}`);
      const data = await res.json();
      setMyPosts(data);
   };
   ...
   return (
      <div className='flex'>
         ...
         <div className='mx-auto flex-grow'>
            <h2 className='title uppercase p-10 text-center mb-10 bg-secondary text-white text-2xl font-semibold'>My Properties </h2>
