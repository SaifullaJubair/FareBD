         ...
         <div className="">
            <div className=" my-20">
               <div className="p-8 bg-primary sm:p-16">
                  <div className="py-6 max-w-[1440px] w-[95%] mx-auto flex flex-col lg:flex-row justify-center lg:items-center mt-10 mb-28">
            ...
            <div className="-mt-48 mb-20">
               <div className="py-14 max-w-[1440px] w-[95%] mx-auto bg-white">
                  <Marquee speed={40}>
