...
const Division = () => {
  return (
    <div className="max-w-[1440px] w-[95%] mx-auto ">
      <div className="my-24">
        <h3 className="text-secondary text-sm text-center font-semibold">
          We are offering the best real estate
        </h3>
        <h1 className="font-bold mb-8 mt-2 text-center text-primary lg:text-5xl md:text-4xl text-3xl">
        ...
        <div className="grid grid-cols-1 w-full  md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="  md:col-span-2 duration-300 hover:-translate-y-2 ">
            ...
            >
              <div className=" text-white p-6  ">
                <h2 className="text-xl mb-2 bg-secondary px-3 py-2  text-center">
                  Khulna
                </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:col-span-2 gap-4  ">
            ...
            <div
              className=" shadow-md h-52 w-full duration-300 hover:-translate-y-2 "
              style={{
            ...
            >
              <div className="flex items-end h-full  justify-center">
                <div className="p-4 text-white">
                  <h2 className="text-sm mb-1 bg-secondary w-1/2 py-1 text-center">
                    Dhaka
                  </h2>
                  <div className="flex text-sm ">
                    <p className="pr-2">
