...
const about = () => {
  ...
  return (
    <div>
      ...
      <section class=" bg-gray-100 -mt-96">
        <div class="container mx-auto px-4">
          ...
          <div class="flex flex-wrap items-center mt-16">
            <div class="mt-36 sm:mt-52 md:mt-24 lg:mt-8 w-full md:w-5/12 mr-auto ml-auto  rounded-tl-3xl rounded-br-3xl  bg-gray-200 bg-opacity-80 p-4">
              ...
              <p class="text-lg leading-relaxed mt-0 mb-4 text-blueGray-600">
