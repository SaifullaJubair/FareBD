                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
                        <div className="single-team bg-white duration-300 group pt-14 p-8 text-center hover:shadow-custom rounded-2xl">
                            <div className="border-4 border-white duration-300 group-hover:border-green inline-block rounded-full p-1">
                                <img src="https://digity.netlify.app/assets/images/team/1.png" className="mx-auto rounded-full team" alt="" />
                            </div>
                            ...
                            <div className="text-center mx-auto">
                                ...
                                <div className="flex justify-center items-center">
                                    <a href=""> <BsFacebook className="text-3xl  hover:text-orange-500"></BsFacebook></a>
                                    <a href=""><BsLinkedin className="mx-3   text-3xl hover:text-orange-500"></BsLinkedin> </a>
                                    <a href=""><BsTwitter className="text-3xl  hover:text-orange-500"></BsTwitter> </a>
                        ...
                        <div className="single-team bg-white duration-300 group pt-14 p-8 text-center hover:shadow-custom rounded-2xl">
                            ...
                            <div className="text-center mx-auto">
                                ...
                                <div className="flex justify-center items-center">
                                    <a href="https://www.facebook.com/profile.php?id=100006098568214"> <BsFacebook className="text-3xl  hover:text-orange-500"></BsFacebook></a>
                                    <a href="https://www.linkedin.com/in/amit-kumar-paul-p1/"><BsLinkedin className="mx-3   text-3xl hover:text-orange-500"></BsLinkedin> </a>
                                    <a href="https://twitter.com/AmitPaultl"><BsTwitter className="text-3xl  hover:text-orange-500"></BsTwitter> </a>
                        ...
                        <div className="single-team bg-white duration-300 group pt-14 p-8 text-center hover:shadow-custom rounded-2xl">
                            ...
                            <div className="text-center mx-auto">
                                ...
                                <div className="flex justify-center items-center">
                                    <a href="https://www.facebook.com/anik.kumaardatta"> <BsFacebook className="text-3xl  hover:text-orange-500"></BsFacebook></a>
                                    <a href="https://www.linkedin.com/in/anik-datta-7809a2203"><BsLinkedin className="mx-3   text-3xl hover:text-orange-500"></BsLinkedin> </a>
                                    <a href=""><BsTwitter className="text-3xl  hover:text-orange-500"></BsTwitter> </a>
                        ...
                        <div className="single-team bg-white duration-300 group pt-14 p-8 text-center hover:shadow-custom rounded-2xl">
                            ...
                            <div className="text-center mx-auto">
                                ...
                                <div className="flex justify-center items-center">
                                    <a href="https://www.facebook.com/profile.php?id=100011638141120"> <BsFacebook className="text-3xl  hover:text-orange-500"></BsFacebook></a>
                                    <a href=""><BsLinkedin className="mx-3   text-3xl hover:text-orange-500"></BsLinkedin> </a>
                                    <a href=""><BsTwitter className="text-3xl  hover:text-orange-500"></BsTwitter> </a>
                        ...
                        <div className="single-team bg-white duration-300 group pt-14 p-8 text-center hover:shadow-custom rounded-2xl">
                            ...
                            <div className="text-center mx-auto">
                                ...
                                <div className="flex justify-center items-center">
                                    <a href="https://www.facebook.com/infected.mr"> <BsFacebook className="text-3xl  hover:text-orange-500"></BsFacebook></a>
                                    <a href=""><BsLinkedin className="mx-3   text-3xl hover:text-orange-500"></BsLinkedin> </a>
                                    <a href=""><BsTwitter className="text-3xl  hover:text-orange-500"></BsTwitter> </a>
                        ...
                        <div className="single-team bg-white duration-300 group pt-14 p-8 text-center hover:shadow-custom rounded-2xl">
                            ...
                            <div className="text-center mx-auto">
                                ...
                                <div className="flex justify-center items-center">
                                    <a href="https://www.facebook.com/imran.skat"> <BsFacebook className="text-3xl  hover:text-orange-500"></BsFacebook></a>
                                    <a href=""><BsLinkedin className="mx-3   text-3xl hover:text-orange-500"></BsLinkedin> </a>
                                    <a href=""><BsTwitter className="text-3xl  hover:text-orange-500"></BsTwitter> </a>
